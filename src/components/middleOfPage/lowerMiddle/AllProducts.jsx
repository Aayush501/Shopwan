...
const AllProducts = ({ clickedProduct, setClickedProduct, productPageProduct, setProductPageProduct}) => {
        ...
        <Row className="g-0 justify-content-center">
          {posts.map((post, index) => (
            <Col key={index} xs={12} sm={6} md={4} lg={3} xl={2} className="d-flex">
              <ProductCard ifCartPage={false} ifWishlistPage={false} postData={post} clickedProduct={clickedProduct} setClickedProduct={setClickedProduct} productPageProduct={productPageProduct} setProductPageProduct={setProductPageProduct} />
            </Col>
          ))}
        </Row>
      )}
